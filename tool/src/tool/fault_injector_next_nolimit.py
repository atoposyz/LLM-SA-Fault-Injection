...
class Fast_SA_FaultInjector:
    ...
    def _inject_bit_error(self, tensor: torch.Tensor, mask: torch.Tensor, op: str):
        ...
        out = torch.nan_to_num(out, nan=1000.0, posinf=1000.0, neginf=-1000.0)
    ...
    def hook_fn(self, module, input_tuple, output_tuple):
        ...
        Y_faulty = torch.nan_to_num(Y_faulty, nan=1000.0, posinf=1000.0, neginf=-1000.0)
        Y_faulty = torch.clamp(Y_faulty, -1000.0, 1000.0)
