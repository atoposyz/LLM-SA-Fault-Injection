        ...
        with open(output_path, "a", encoding="utf-8") as f:
            for idx, sample in enumerate(tqdm(samples)):
                ...
                try:
                    ...
                    resultoutput(token_length=token_length, is_aborted=False, decoded=decoded, idx=sample_index[idx], prompt=prompt, sample=sample, layerid=layerid, layertype=layertype, posid=posid, f=f, elapsed_time=time.time() - t_rerun_start)
