"""
Plot stuck-at normalized severity weights — FP32, 3 sources:
weight, activation (input), psum (output).

Model: boltuix/bert-emotion | Dataset: boltuix/emotions-dataset
"""
import json
...
def plot():
    ...
    fig.suptitle(
        ...
        "boltuix/bert-emotion  |  transform=log1p  |  2M elements each",
