...
def main():
    ...
    old_data = {
        ...
        ("input",  0): load_bit_csv(os.path.join(SCRIPT_DIR, "..", "..", "bert", "result", "accuracy_drop_plot_form_input_stuck_0.csv"),  "stuck_0_input_acc_drop"),
        ...
        ("weight", 0): load_bit_csv(os.path.join(SCRIPT_DIR, "..", "..", "bert", "result", "accuracy_drop_plot_form_weight_stuck_0.csv"), "stuck_0_weight_acc_drop"),
    }
