...
if __name__ == "__main__":
    ...
    with open("/workplace/home/mayongzhe/faultinject/projects/qwen3-0.6b/config/layerstructure.txt", "w") as f1:
        with redirect_stdout(f1):
            print_model_layers(model)

    # 保存 named_modules 输出的模块名
    with open("/workplace/home/mayongzhe/faultinject/projects/qwen3-0.6b/config/layernames.txt", "w") as f2:
